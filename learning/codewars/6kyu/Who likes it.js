...
//   if (names.length === 3) return `${names.slice(0, 2)} and ${names.slice(-1)} like this`;
//   if (names.length >= 4) return `${names.slice(0, 2)} and ${names.length - 2} others like this`;
// }
...
function likes(names) {
  switch (names.length) {
    ...
    case 3:
      return `${names.slice(0, 2)} and ${names.slice(-1)} like this`;
    default:
      return `${names.slice(0, 2)} and ${names.length - 2} others like this`;
  }
}
